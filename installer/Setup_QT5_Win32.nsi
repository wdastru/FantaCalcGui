...
; Qt
!define QT1 "C:\Qt\5.1.1\mingw48_32\bin"
!define QT2 "C:\Qt\Tools\QtCreator\bin"

; HM NIS Edit Wizard helper defines
!define PRODUCT_NAME "FantaCalcGui"
!define PRODUCT_VERSION "v3.4.0"
!define PRODUCT_PUBLISHER "EPTADONE Software Inc."
!define PRODUCT_WEB_SITE "http://www.cim.unito.it/website/private/fantacalcio/"
...
!define PRODUCT_OUTDIR "D:\Sorgenti\FantaCalcGuiNew_QT5_Win32Build\installer"
...
Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite try
  File "D:\Sorgenti\FantaCalcGuiNew_QT5_Win32Build\FantaCalcGui.exe"
  File "${QT1}\libstdc++-6.dll"
  File "${QT1}\libgcc_s_dw2-1.dll"
  File "${QT2}\icuuc51.dll"
  File "${QT2}\icuin51.dll"
  File "${QT2}\icudt51.dll"
  File "${QT1}\libwinpthread-1.dll"
  File "${QT2}\Qt5Core.dll"
  File "${QT2}\Qt5Gui.dll"
  File "${QT2}\Qt5Network.dll"
  File "${QT2}\Qt5Xml.dll"
  File "${QT2}\Qt5Widgets.dll"
